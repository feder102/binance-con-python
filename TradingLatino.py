...
class TradingLatino:
    ...
    def obtenerKlines(self):
        ...
        self.klines     = klines = client.get_historical_klines(self.simbolo, Client.KLINE_INTERVAL_1HOUR, "3 year ago UTC")
    ...
    def mostrarValoresComprados(self):
        print("*****************************************")
        print("PRECIO Ganado  : " + str(self.dinero_final))
        print("totales moneda : " + str(self.btc_cant))
        print("*****************************************")